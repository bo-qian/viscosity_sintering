...
# Run MOOSE
mpiexec -n $SLURM_NTASKS ./viscosity_sintering-opt -i ./examples/2D/BDF1_test/viscosity_sintering_MultiApp_2D.i Outputs/file_base="${OUTPUT_DIR}/${TASK_ID}_VS2D" --color off 2>&1 | tee -a "${OUTPUT_DIR}/${TASK_ID}.log"
